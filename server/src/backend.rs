...
pub(crate) async fn run_in_compute_pool<T, F>(
...
pub(crate) const IDEOLOGY_MODIFIER_SUFFIXES: &[&str] =
...
pub(crate) fn build_dynamic_ideology_keywords(scanner_data: &ScannerData) -> Vec<String> {
...
impl ValidationCtx {
    ...
    fn check_semantic(
        ...
        // Detect file type from URI for scope inference (shared with hover/completion).
        ...
        let ctx = ValidationContext {
            ...
            states: &self.scanner_data.states,
        ...
        let mut visitors: Vec<Box<dyn rules::visitor::AstVisitor>> = vec![
            ...
            rules::state_definitions::StateDefinitionRule::map_visitor(uri),
            rules::strategic_regions::StrategicRegionRule::visitor(uri),
        ...
        let rules: Vec<Box<dyn ValidationRule>> = vec![
            ...
            Box::new(rules::focus_cost::FocusCostRule),
